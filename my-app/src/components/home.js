...
const Home = () => {
  ...
  useEffect(() => {
    ...
    Object.keys(localStorage).forEach((el) => {
      if (el === "token") flag = true;
    });
    if (!flag) navigate(`/loggin`);
    else {
  ...
  return (
    <div>
      ...
      <input
        type="text"
        className="custom-file-input searchInput"
        placeholder="Search"
        id="search"
        name="message"
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="contenedor-horizontal">
                    <p className="contenido-horizontal texto-time">
                      {timeToPublish(item.updatedAt)}min ago
                    </p>
      ...
      {cardSee === false && (
        <div className="d-flex justify-content-center">
          ...
          <span className="sr-only" style={{ marginLeft: "2px" }}>
            Loading...
          </span>
        </div>
      )}
